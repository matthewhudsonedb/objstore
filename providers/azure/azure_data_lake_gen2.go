...
func (b *DataLakeGen2Bucket) Upload(ctx context.Context, name string, r io.Reader) error {
	// for azure data lake gen 2, the folder name doesn't have '/' in the suffix.
	name = strings.TrimSuffix(name, DirDelim)
...
func (b *DataLakeGen2Bucket) GetAndReplace(ctx context.Context, name string, f func(io.ReadCloser) (io.ReadCloser, error)) error {
